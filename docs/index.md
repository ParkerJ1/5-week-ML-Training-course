...
## Week 2: Neural Networks Foundations

**[📋 Week 2 Overview](Week2_Overview.md)**

- [Day 6: Neural Network Theory](Week2_Day6.md)
- [Day 7: Backpropagation and Training](Week2_Day7.md)
- [Day 8: Introduction to PyTorch](Week2_Day8.md)
...
- [Day 11: CNN Theory & Convolutions](Week3_Day11.md)
- [Day 12: LeNet & AlexNet Architectures](Week3_Day12.md)
- [Day 13: Modern Architectures (ResNet, VGG)](Week3_Day13.md)
...
1. **Read the Overview** - Start each week by reading the weekly overview
2. **Follow the Daily Plan** - Each day has a structured 8-hour schedule
